...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "bin/redirect_app", "example.rb", "example.ru", "lib/redirect.rb", "lib/redirect/test.rb", "spec/helper.rb", "spec/rack_spec.rb"]
  s.has_rdoc = true
